...
namespace FinEng.DataAccess.Migrations
{
    ...
    [Migration("20231216211430_addOrderHeaderAndDetailsToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinEng.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinEng.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinEng.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FinEng.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("FinEng.Models.OrderDetail", b =>
                {
                    b.HasOne("FinEng.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FinEng.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("FinEng.Models.OrderHeader", b =>
                {
                    b.HasOne("FinEng.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
